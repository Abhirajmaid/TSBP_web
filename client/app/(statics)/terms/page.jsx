...
const page = () => {
  return (
    <>
      <div className=" w-[70%] mx-auto px-[6%] pt-[6%] text-justify bg-bg">
        <h1 className="font-extrabold text-3xl mb-5">Term of Condition</h1>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to The SuperBike Project, Three Jewels,
              Tilekar Nagar, Kondhawa bk.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to The SuperBike Project,
              accessible from
              <a
                href="https://The SuperBike Projectagency.com"
                rel="external nofollow noopener"
                target="_blank"
              >
                https://The SuperBike Projectagency.com
              </a>
            </p>
          </li>
          <li>
        ...
        <ul>
          <li>
            <p>
              ...
              <a
                href="https://The SuperBike Projectagency/contact-us"
                rel="external nofollow noopener"
                target="_blank"
              >
                https://The SuperBike Projectagency/contact-us
              </a>
            </p>
          </li>
          <li>
